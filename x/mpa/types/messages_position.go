...
func NewMsgCreatePosition(creator string, collateral int32, supply int32) *MsgCreatePosition {
...
func NewMsgUpdatePosition(creator string, id uint64, collateral int32, supply int32) *MsgUpdatePosition {
